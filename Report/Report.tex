...
\title{Research on the correlation between PID controller performance and its update frequency}
% PID控制器性能与其更新频率关系的研究

\author{
    \IEEEauthorblockN{Student Number (Zhinan Chen)}
    \and
...
\caption{Overall result picture. Red dots represents oscillate. Line label is center frequency of the neighborhood.}% 遍历频率域的方法
\label{fig_appendix}
\end{figure}
